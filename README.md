...
This portfolio uses AI the way I'd expect a competent PM to use any tool: directed, checked, and never trusted past the point I've verified it. Four case studies, one from each core area of practice — prioritization, process design, stakeholder communication, and operational visibility.

Limited on time? For how I actually made decisions across this portfolio — including which AI tools I used where, and why — read the [Methodology page](https://github.com/zinaleeHQ/zinaleeHQ/blob/main/METHODOLOGY.md).

This is also a work in progress. [Vista's interactive prototype is live](https://zinaleeHQ.github.io/project-vista/dashboard/); the other three prototypes for each case study are next. A layer on AI governance and bias is planned.

---

## ↳︎ How to Navigate This Portfolio
...
![SAFe POPM](https://img.shields.io/badge/SAFe-POPM%20Certified-0052CC?style=flat-square&logo=jira&logoColor=white)
![Agile](https://img.shields.io/badge/Agile-Scrum%20%7C%20Kanban-brightgreen?style=flat-square)
![Lean Six Sigma](https://img.shields.io/badge/Lean-Six%20Sigma-red?style=flat-square)
![WSJF](https://img.shields.io/badge/Prioritization-WSJF%20%7C%20RICE%20%7C%20Value--Effort-blueviolet?style=flat-square)
![Healthcare IT](https://img.shields.io/badge/Healthcare%20IT-HL7%20%7C%20EMR%20%7C%20RCM-teal?style=flat-square)
![AI Tools](https://img.shields.io/badge/AI-Prompt%20Engineering%20%7C%20Agent%20Design-orange?style=flat-square)
![Data](https://img.shields.io/badge/Data-Analytics%20%7C%20Dashboards%20%7C%20KPIs-informational?style=flat-square)
![Compliance](https://img.shields.io/badge/Compliance-HIPAA%20%7C%20SOC%202%20%7C%20Zero--Trust-critical?style=flat-square)

---

## A Note on This Portfolio

These are case studies built from publicly available information about real enterprise healthcare technology — not affiliated with any named organization, and built entirely on mock data constructed to reflect realistic operational constraints.
...
Each project has a live page with a one-click **Copy Prompt** button — grabs the full prompt plus data, ready to paste into Claude, GPT-4, or Gemini. Swap in your own data if you want to see how the same structure handles a different scenario entirely.

| Project | Prompt Copy Page |
|---|---|
| Project Horizon | [zinaleeHQ.github.io/project-horizon](https://zinaleeHQ.github.io/project-horizon/) |
